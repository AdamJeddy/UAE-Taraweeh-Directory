...
const RAMADAN_START = new Date('2026-02-18T00:00:00+04:00'); // approximate
...
function updateUILanguage() {
    ...
    if (contributeAlt) {
        const emailLink = contributeAlt.querySelector('a');
        contributeAlt.innerHTML = `${t('orEmail')} `;
        if (emailLink) contributeAlt.appendChild(emailLink);
    }
